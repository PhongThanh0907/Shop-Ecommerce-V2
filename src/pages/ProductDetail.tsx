        ...
        <div className="col-span-2">
          <div className="flex flex-col justify-center border-2 p-6 border-gray-300 rounded-2xl">
            ...
            <input
              ...
              defaultValue={1}
            />
            <button className="my-4 text-white flex items-center bg-backgroundColor py-3 justify-center gap-2 rounded-3xl font-semibold hover:bg-[#00c0dd] duration-300 active:bg-[#008da3]">
          ...
          <LoadingButton />
          <div className="lds-ring ml-6 mt-10">
            <div />
            <div />
            <div />
            <div />
